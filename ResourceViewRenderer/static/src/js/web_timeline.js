...
odoo.define('web_timeline.TimelineView', function (require) {
    ...
    var TimelineView = View.extend({
        ...
        view_loading: function (fv) {
            ...
            this.fields_view = fv;
            this.parse_colors();
            this.$timeline = this.$el.find(".o_calendar_timeline_widget");
            this.$el.find(".o_calendar_button_today").click($.proxy(this.on_today_clicked, this));
            this.$el.find(".o_calendar_button_day").click($.proxy(this.on_scale_day_clicked, this));
            this.$el.find(".o_calendar_button_week").click($.proxy(this.on_scale_week_clicked, this));
            this.$el.find(".o_calendar_button_month").click($.proxy(this.on_scale_month_clicked, this));
            this.$el.find("o_calendar_button_timeline").click($.proxy(this.on_scale_year_timeline, this));
            this.current_window = {
                  start: new moment(),
