...
//        json.qty = this.get_quantity();
//        json.price_unit =  this.get_unit_price();
        json.discount = this.get_discount();
        json.discount_fixed = this.get_discount_fixed();
        json.discount_total = this.get_discount_total();
        json.discount_percent = this.get_discount_percent();
        json.discountStr = this.get_discount_str();
...
////                self.chrome.do_action('beauty_pos.report_pos_receipt',{additional_context:{
