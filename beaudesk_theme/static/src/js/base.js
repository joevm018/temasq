odoo.define('beaudesk_odoo_theme', function(require) {
    "use strict";
    ...
    ajax.jsonRpc('/web/dataset/call', 'call', {
        ...
        'args': ['beaudesk_theme.theme_customize_backend', base.get_context()]
    }).done(function(data) {
    ...
    var Theme = Widget.extend({
        template: 'beaudesk_theme.theme_customize_backend',
        events: {
