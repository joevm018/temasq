...
TimeGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if ((event.state == 'draft')&& (event.checkin == true)){
		    return '<a class="' + classes.join(' ') + '"' +
			(event.url ?
				' href="' + htmlEscape(event.url) + '"' :
				''
			...
			'>' +
				...
				'</div>' +
				'<div class="fc-bg state_draft_checkin"/>' +
		...
		if ((event.state == 'draft')&& (event.checkin == false)){
		    return '<a class="' + classes.join(' ') + '"' +
			(event.url ?
				' href="' + htmlEscape(event.url) + '"' :
				''
			...
			'>' +
				...
				'</div>' +
				'<div class="fc-bg state_draft_not_checkin"/>' +
				/* TODO: write CSS for this
				(isResizableFromStart ?
					'<div class="fc-resizer fc-start-resizer" />' :
					''
		...
		if (event.state == 'invoiced'){
			...
			'>' +
				...
				'</div>' +
				'<div class="fc-bg state_invoiced"/>' +
				/* TODO: write CSS for this
				(isResizableFromStart ?
					'<div class="fc-resizer fc-start-resizer" />' :
					''
